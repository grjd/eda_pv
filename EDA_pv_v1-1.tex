...
%Table \ref{tab:buskl}
\begin{center}
\captionof{tab:testloyals}{T-test for the means of two independent samples scores in year 1 for subjects that participated in year $k, (k=2..6)$, versus those that missed their $k-th$ visit.}
...
\begin{figure}[H]
        \centering
        \includegraphics[keepaspectratio,width=0.9\linewidth]{figures/abuelos}
