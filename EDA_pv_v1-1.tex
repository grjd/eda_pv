...
Figure \ref{fig:anthro} shows the histogram for anthropometric variables body mass index (BMI), abdominal perimeter, weight and height, measured in the first visit.
...
\begin{figure}[H]
        ...
        \caption{Histogram of hand laterality (left) and sex (right). There is majority of females, 753 versus 427 males. The right handed are 1106, left 19, ambidextrous 39 and 16 were forced right about born left.} 
        \label{fig:sexlat}
\end{figure}
